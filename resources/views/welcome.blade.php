...
<body>
    <div class="container mt-3">
        <div class="row">
            <h3 class="col-10">Registration Form</h3>
        ...
        @endif
        <form action="{{ route('store.user_data') }}" method="post" enctype="multipart/form-data"
            class="was-validated">
            @csrf
            <div class="mb-3 mt-3">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="datepicker" placeholder="Enter Your Date Of Birth"
            ...
            <div class="mb-3 mt-3">
                ...
                <input type="text" class="form-control" id="uname" placeholder="Enter Your City Name" name="city"
                    required>
                <div class="valid-feedback">Valid.</div>
                <div class="invalid-feedback">Please fill out this field.</div>
            </div>
            <div class="mb-3 mt-3">
                ...
                <input type="text" class="form-control" id="uname" placeholder="Enter Your Country Name "
...
<tbody>
    @foreach ($product as $row)
        <tr>
            ...
            @php
                $color = App\Models\color::where('id', '=', $row->color_id)->first();
            @endphp
            <td>{{ $color->id }}</td>
            @php
                $categoryName = App\Models\category::where('id', '=', $row->cat_id)->first();
            @endphp
